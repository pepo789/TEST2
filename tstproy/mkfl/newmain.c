...
ALLEGRO_BITMAP *pila=NULL;
ALLEGRO_FONT * fiont=NULL;
/*
 * 
 */
int main(int argc, char** argv) {
   ...
   FixDirectory();
   fiont = al_load_ttf_font("UbuntuMono-R.ttf",15,0 );   
   ...
   while(1)
   {
       ...
       //RECEPTORES DE EVENTOS
        ...
        //pinto todo de blanco para dibujar arriba de nuevo
            ...
            al_draw_rotated_bitmap(copadares,0, 0,copadares_x+50,copadares_y+25,HALFPI,0);
